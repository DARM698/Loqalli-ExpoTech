    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok && data.success) {
                ...
                // REDIRECCIÓN ACTUALIZADA: Ruta directa a la carga de microexperiencias
          ...
          <div className=" w-full max-w-2xl h-[540px] bg-white rounded-2xl shadow-lg overflow-hidden grid grid-cols-1 md:grid-cols-2">
            ...
            <form onSubmit={handleSubmit} className="text-black flex flex-col justify-center px-5 py-3">
              ...
              <div className="flex items-center gap-3 mb-4 text-sm text-[#56423D]">
                <input type="checkbox" className="w-4 h-4 rounded border-[#F1EBE0] accent-[#DA653B]" />
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="text-[white] border border-[#DA653B] rounded font-medium items-center bg-[#DA653B] w-full p-2 transition-all active:scale-95 disabled:opacity-50"
              >
